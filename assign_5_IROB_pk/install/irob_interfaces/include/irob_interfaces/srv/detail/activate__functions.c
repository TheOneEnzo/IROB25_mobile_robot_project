...
irob_interfaces__srv__Activate_Request__create()
{
  ...
  irob_interfaces__srv__Activate_Request * msg = (irob_interfaces__srv__Activate_Request *)allocator.allocate(sizeof(irob_interfaces__srv__Activate_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(irob_interfaces__srv__Activate_Request));
  bool success = irob_interfaces__srv__Activate_Request__init(msg);
  if (!success) {
...
irob_interfaces__srv__Activate_Request__destroy(irob_interfaces__srv__Activate_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    irob_interfaces__srv__Activate_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
irob_interfaces__srv__Activate_Request__Sequence__init(irob_interfaces__srv__Activate_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irob_interfaces__srv__Activate_Request * data = NULL;

  if (size) {
    data = (irob_interfaces__srv__Activate_Request *)allocator.zero_allocate(size, sizeof(irob_interfaces__srv__Activate_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = irob_interfaces__srv__Activate_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        irob_interfaces__srv__Activate_Request__fini(&data[i - 1]);
      }
...
irob_interfaces__srv__Activate_Request__Sequence__fini(irob_interfaces__srv__Activate_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      irob_interfaces__srv__Activate_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irob_interfaces__srv__Activate_Request__Sequence * array = (irob_interfaces__srv__Activate_Request__Sequence *)allocator.allocate(sizeof(irob_interfaces__srv__Activate_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = irob_interfaces__srv__Activate_Request__Sequence__init(array, size);
  if (!success) {
...
irob_interfaces__srv__Activate_Request__Sequence__destroy(irob_interfaces__srv__Activate_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    irob_interfaces__srv__Activate_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
irob_interfaces__srv__Activate_Request__Sequence__are_equal(const irob_interfaces__srv__Activate_Request__Sequence * lhs, const irob_interfaces__srv__Activate_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!irob_interfaces__srv__Activate_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  irob_interfaces__srv__Activate_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(irob_interfaces__srv__Activate_Request);
    irob_interfaces__srv__Activate_Request * data =
      (irob_interfaces__srv__Activate_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irob_interfaces__srv__Activate_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irob_interfaces__srv__Activate_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!irob_interfaces__srv__Activate_Request__copy(
...
irob_interfaces__srv__Activate_Response__init(irob_interfaces__srv__Activate_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    irob_interfaces__srv__Activate_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irob_interfaces__srv__Activate_Response * msg = (irob_interfaces__srv__Activate_Response *)allocator.allocate(sizeof(irob_interfaces__srv__Activate_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(irob_interfaces__srv__Activate_Response));
  bool success = irob_interfaces__srv__Activate_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
irob_interfaces__srv__Activate_Response__Sequence__init(irob_interfaces__srv__Activate_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irob_interfaces__srv__Activate_Response * data = NULL;

  if (size) {
    data = (irob_interfaces__srv__Activate_Response *)allocator.zero_allocate(size, sizeof(irob_interfaces__srv__Activate_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = irob_interfaces__srv__Activate_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        irob_interfaces__srv__Activate_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
irob_interfaces__srv__Activate_Response__Sequence__fini(irob_interfaces__srv__Activate_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      irob_interfaces__srv__Activate_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irob_interfaces__srv__Activate_Response__Sequence * array = (irob_interfaces__srv__Activate_Response__Sequence *)allocator.allocate(sizeof(irob_interfaces__srv__Activate_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = irob_interfaces__srv__Activate_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
irob_interfaces__srv__Activate_Response__Sequence__destroy(irob_interfaces__srv__Activate_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    irob_interfaces__srv__Activate_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
irob_interfaces__srv__Activate_Response__Sequence__are_equal(const irob_interfaces__srv__Activate_Response__Sequence * lhs, const irob_interfaces__srv__Activate_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!irob_interfaces__srv__Activate_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  irob_interfaces__srv__Activate_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(irob_interfaces__srv__Activate_Response);
    irob_interfaces__srv__Activate_Response * data =
      (irob_interfaces__srv__Activate_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irob_interfaces__srv__Activate_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irob_interfaces__srv__Activate_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!irob_interfaces__srv__Activate_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
